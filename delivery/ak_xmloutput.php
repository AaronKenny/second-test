...
+---------------------------------------------------------------------------+
$Id: template.php 79311 2011-11-03 21:18:14Z chris.nutting $
*/
...
$clickTag = '<url>'.$clickUrl.'</url><image>'.$aBanner.'</image>';
$clickTagEnd = '';
} else {
$clickTag = '';
$clickTagEnd = '';
...
if (empty($target)) {
$target = '_blank';  }
$outputbuffer = $g_prepend . $row['default_banner_destination_url']  .$target .  $row['default_banner_image_url'] . $g_append;
